...
export default function NavBar() {
  return (
    <nav
      class="relative flex w-full flex-wrap items-center justify-between bg-zinc-50 py-2 shadow-dark-mild dark:bg-blue-500 lg:py-4"
      data-twe-navbar-ref
    >
        ...
        >
          ...
          >
            ...
            <li class="my-4 ps-2 lg:my-0 lg:pe-1 lg:ps-2" data-twe-nav-item-ref>
              <Link
                href="/"
                class="text-black/60 dark:text-white lg:px-2"
                aria-current="page"
          ...
          <div class="flex items-center">
            ...
            >
              <Link
                href="/user/login"
                className="hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:text-secondary-600 dark:hover:text-secondary-500 dark:focus:text-secondary-500 dark:active:text-secondary-500"
              >
                Log in
              </Link>
            </button>
